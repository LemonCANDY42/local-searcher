<p align="center">
  <img src="https://img.shields.io/badge/🔍-local--searcher-blueviolet?style=for-the-badge&labelColor=0d1117&color=58a6ff" alt="agent-searchkit">
</p>
...
<p align="center">
  <a href="#quickstart">Quickstart</a> · <a href="#features">Features</a> · <a href="#为什么选择-agent-searchkit">Why</a> · <a href="#integration">Integration</a> · <a href="#api">API</a> · <a href="#architecture">Architecture</a>
</p>
...
**agent-searchkit** 是一个本地搜索基础设施，为 AI Agent 提供搜索、reranking 和研究能力。
...
| Tool | 能力 | 一句话 |
|------|------|--------|
| `web_searchkit_search` | SearXNG 搜索 + 多版本 rerank | 搜索 + rerank |
| `web_searchkit_research` | 断点续传式深度研究 | 长任务可断点续传 |
